...
import { Button, buttonVariants } from "@/registry/abui/ui/button"
  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        weekday: cn("text-muted-foreground rounded-md flex-1 font-normal text-[0.8rem]", defaultClassNames.weekday),
      ...
      components={{
        Root: ({ className, rootRef, ...props }) => {
          return <div data-slot="calendar" className={cn(className)} ref={rootRef} {...props} />
        },
