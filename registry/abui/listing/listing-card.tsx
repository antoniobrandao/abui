...
export function ListingCard({
  ...
  return (
    <Card className={cn("w-full p-0 bg-transparent aspect-square border-0 gap-4 min-w-0", className)}>
      ...
      <CardHeader className="p-0 gap-0">
        <CardTitle className="flex items-center gap-2 text-sm tracking-tight font-medium">
          ...
          <div className="flex items-center gap-1 ml-auto">
            <StarIcon className="fill-foreground size-3" /> {rating} ({reviewCount})
          </div>
        </CardTitle>
