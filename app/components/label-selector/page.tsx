                    ...
                    <LabelSelector.Root value={variant} onValueChange={setVariant}>
                      ...
                      <LabelSelector.Content className="gap-3">
                        ...
                        <LabelSelector.Item
                          value="enterprise"
                          label="Enterprise"
                          className="min-w-[5rem] h-12 text-base"
                        />
                      </LabelSelector.Content>
                    </LabelSelector.Root>
                  </div>
                  ...
                  <div className="space-y-6">
                    <div className="space-y-2" id="labelselector-root-props">
                      ...
                      <ul className="text-muted-foreground space-y-1 text-sm ml-4">
                        ...
                        <li>
                          <code className="code-text">className</code> - string - Override default container styles
                        </li>
                      </ul>
                    </div>
                    <div className="space-y-2" id="labelselector-label-props">
                      ...
                      <ul className="text-muted-foreground space-y-1 text-sm ml-4">
                        <li>
                          <code className="code-text">value</code> - string (required) - The label text to display
                        </li>
                        <li>
                    ...
                    <div className="space-y-2" id="labelselector-content-props">
                      ...
                      <ul className="text-muted-foreground space-y-1 text-sm ml-4">
                        <li>
                          <code className="code-text">className</code> - string - Useful for customizing gap spacing
                        </li>
                        <li>
                          <code className="code-text">children</code> - React.ReactNode - LabelSelector.Item components
                        </li>
                      </ul>
                    </div>
                    <div className="space-y-2" id="labelselector-item-props">
                      ...
                      <ul className="text-muted-foreground space-y-1 text-sm ml-4">
                        <li>
                          <code className="code-text">value</code> - string (required) - The internal value for this
                          option
                        </li>
                        <li>
                          <code className="code-text">label</code> - string - The display label (defaults to value if
                          not provided)
                        </li>
                        <li>
                          <code className="code-text">variant</code> - &quot;default&quot; | &quot;outline&quot; |
                          &quot;ghost&quot; | &quot;solid&quot; - Visual style variant (default: &quot;default&quot;)
                        </li>
                        <li>
                        ...
                        <li>
                          <code className="code-text">className</code> - string - Additional custom styles
                        </li>
                      </ul>
                    </div>
                  </div>
