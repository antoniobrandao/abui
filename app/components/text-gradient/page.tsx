                ...
                <div className="space-y-6">
                  <div className="space-y-2">
                    ...
                    <ul className="text-muted-foreground space-y-1 text-sm ml-4">
                      <li>
                        <code className="code-text">children</code> - React.ReactNode - The text content to display with
                        the gradient effect
                      </li>
                      <li>
                        <code className="code-text">spread</code> - number - The spread distance for the gradient effect
                        in pixels (default: 22)
                      </li>
                      <li>
                        <code className="code-text">highlightColor</code> - string - The background color for the
                        gradient highlight (default: &quot;hsl(var(--background))&quot;)
                      </li>
                      <li>
                        <code className="code-text">baseColor</code> - string - The base text color (shows through the
                        gradient) (default: &quot;hsl(var(--muted-foreground))&quot;)
                      </li>
                      <li>
                        <code className="code-text">duration</code> - number - Animation duration in seconds (default:
                        3)
                      </li>
                      <li>
                        <code className="code-text">className</code> - string - Additional CSS classes to apply to the
                        component
                      </li>
                    </ul>
                  </div>
              ...
              <div id="how-it-works">
                ...
                <div className="space-y-3 text-sm text-muted-foreground">
                  ...
                  <ul className="list-disc list-inside space-y-2 ml-4">
                    ...
                    <li>
                      <strong>Background clipping:</strong> The <code className="code-text">bg-clip-text</code> property
                      clips the background to the text shape
                    </li>
                    <li>
                      <strong>CSS animation:</strong> Animates the{" "}
                      <code className="code-text">background-position</code> from 0% to 200% for a smooth scrolling
                      effect
                    </li>
                    <li>
