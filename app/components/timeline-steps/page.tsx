                ...
                <div className="space-y-6">
                  <div className="space-y-2" id="timelinesteps-props">
                    ...
                    <ul className="text-muted-foreground space-y-1 text-sm ml-4">
                      <li>
                        <code className="code-text">orientation</code> - &quot;vertical&quot; | &quot;horizontal&quot; -
                        Layout direction (default: &quot;vertical&quot;)
                      </li>
                      <li>
                        <code className="code-text">position</code> - &quot;left&quot; | &quot;right&quot; |
                        &quot;alternate&quot; - Position of the timeline line
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="space-y-2" id="timelinestepsitem-props">
                    ...
                    <ul className="text-muted-foreground space-y-1 text-sm ml-4">
                      <li>
                        <code className="code-text">orientation</code> - &quot;vertical&quot; | &quot;horizontal&quot; -
                        Layout direction for the item
                      </li>
                      <li>
                        <code className="code-text">status</code> - &quot;default&quot; | &quot;completed&quot; |
                        &quot;current&quot; | &quot;upcoming&quot; - Visual status of the item
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="space-y-2" id="timelinestepsconnector-props">
                    ...
                    <ul className="text-muted-foreground space-y-1 text-sm ml-4">
                      ...
                      <li>
                        <code className="code-text">variant</code> - &quot;default&quot; | &quot;dashed&quot; |
                        &quot;dotted&quot; - Line style
                      </li>
                      <li>
                        <code className="code-text">status</code> - &quot;default&quot; | &quot;completed&quot; |
                        &quot;current&quot; | &quot;upcoming&quot; - Visual status
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="space-y-2" id="timelinestepsicon-props">
                    ...
                    <ul className="text-muted-foreground space-y-1 text-sm ml-4">
                      ...
                      <li>
                        <code className="code-text">variant</code> - &quot;default&quot; | &quot;primary&quot; |
                        &quot;secondary&quot; | &quot;destructive&quot; | &quot;outline&quot; - Icon style variant
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="space-y-2" id="other-components-props">
                    ...
                    <ul className="text-muted-foreground space-y-1 text-sm ml-4">
                      <li>
                        <code className="code-text">TimelineStepsHeader</code> - Container for icon and title row
                      </li>
                      <li>
                        <code className="code-text">TimelineStepsContent</code> - Container for description and time
                      </li>
                      <li>
                        <code className="code-text">TimelineStepsTitle</code> - Title text component
                      </li>
                      <li>
                        <code className="code-text">TimelineStepsDescription</code> - Description text component
                      </li>
                      <li>
                        <code className="code-text">TimelineStepsTime</code> - Time/date display component
                      </li>
                    </ul>
                  </div>
                </div>
