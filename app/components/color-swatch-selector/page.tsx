                  ...
                  <div className="space-y-6">
                    <div className="space-y-2" id="colorswatchselector-root-props">
                      ...
                      <ul className="text-muted-foreground space-y-1 text-sm ml-4">
                        <li>
                          <code className="code-text">value</code> - string - Currently selected color value
                        </li>
                        <li>
                    ...
                    <div className="space-y-2" id="colorswatchselector-content-props">
                      ...
                      <ul className="text-muted-foreground space-y-1 text-sm ml-4">
                        ...
                        <li>
                          <code className="code-text">children</code> - React.ReactNode - ColorSwatchSelector.Item
                          components
                        </li>
                      </ul>
                    </div>
                    <div className="space-y-2" id="colorswatchselector-item-props">
                      ...
                      <ul className="text-muted-foreground space-y-1 text-sm ml-4">
                        <li>
                          <code className="code-text">value</code> - string (required) - The color value (hex format
                          recommended)
                        </li>
                        <li>
                        ...
                        <li>
                          <code className="code-text">className</code> - string - Useful for customizing swatch size
                          (e.g., h-14 w-14)
                        </li>
                      </ul>
                    </div>
