              ...
              <div className="flex flex-col gap-4" id="default-viewport">
                <div className="flex flex-col gap-2">
                  ...
                  <div className="text-sm text-muted-foreground">
                    A primary-colored progress bar at the top of the viewport. Check the top of your screen as you
                    scroll this page!
                  </div>
                </div>
                <ExamplePlusCodeTabs
                    ...
                    <div className="w-full border rounded-lg bg-muted/30 relative">
                      ...
                      <div ref={targetRef} className="h-[300px] overflow-y-auto p-4">
                        <article className="space-y-4 text-sm text-muted-foreground">
                          <p>
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam ac rhoncus quam. Fringilla
                            quam urna. Cras turpis elit, euismod eget ligula quis, imperdiet sagittis justo.
                          </p>
                          <p>
                          ...
                          <p>
                            ...
                            consectetur efficitur metus. Duis efficitur tincidunt odio, sit amet laoreet massa fringilla
                            eu.
                          </p>
                          <p>
                          ...
                          <p>
                            Proin sit amet lacus mollis, semper massa ut, rutrum mi. Sed sem nisi, luctus consequat
                            ligula in, congue sodales nisl.
                          </p>
                          <p>
                          ...
                          <p>
                            ...
                            auctor vehicula malesuada. Aliquam id feugiat sem, sit amet tempor nulla.
                          </p>
                          <p>
                ...
                <div className="space-y-6">
                  <div className="space-y-2">
                    ...
                    <ul className="text-muted-foreground space-y-1 text-sm ml-4">
                      <li>
                        <code className="code-text">height</code> - number (default: 2) - Height of the progress bar in
                        pixels
                      </li>
                      <li>
                        <code className="code-text">color</code> - string (default: &quot;bg-primary&quot;) - Tailwind
                        background color class
                      </li>
                      <li>
                        <code className="code-text">position</code> - &quot;top&quot; | &quot;bottom&quot; (default:
                        &quot;top&quot;) - Position of the progress bar
                      </li>
                      <li>
                        <code className="code-text">container</code> - React.RefObject&lt;HTMLElement&gt; - Optional
                        container element to track scroll for. If not provided, tracks viewport scroll
                      </li>
                      <li>
                        <code className="code-text">className</code> - string - Additional CSS classes
                      </li>
                      <li>
                        <code className="code-text">...props</code> - Extends motion.div props for advanced
                        customization
                      </li>
                    </ul>
                    <div className="flex flex-col gap-2 mt-6" id="positioning-note">
                      ...
                      <p className="text-muted-foreground text-sm">
                        For viewport scroll, the component automatically uses <code className="code-text">fixed</code>{" "}
                        positioning.
                      </p>
                      <p className="text-muted-foreground text-sm">
                        For container scroll, use <code className="code-text">sticky</code> positioning via className
                        and place the progress bar outside the scrollable container.
                      </p>
                    </div>
                  </div>
                </div>
