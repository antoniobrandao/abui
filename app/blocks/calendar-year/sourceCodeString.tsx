  ...
  "cursor-pointer inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-semibold transition-all disabled:pointer-events-none disabled:opacity-50 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive relative h-9 w-9 p-0",
  {
    variants: {
      variant: {
        ...
        "default-success": "bg-green-500 text-background hover:bg-green-600 hover:border-green-600 dark:hover:bg-green-400 dark:hover:border-green-400 border border-green-500",
        ...
        "outline-destructive":
          "border border-destructive bg-transparent shadow-xs text-destructive bg-transparent",
        "outline-accent":
          "border border-accent bg-transparent shadow-xs text-accent bg-transparent",
        "outline-success":
          "border border-green-500 bg-transparent shadow-xs text-green-500 bg-transparent",
    ...
    const buttonContent = (
      <Comp
        ...
        className={cn(
          ...
          "data-[blocked=true]:!cursor-not-allowed data-[blocked=true]:hover:!bg-background",
