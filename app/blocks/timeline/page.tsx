      ...
      <Content>
        ...
        <div className="space-y-4 mb-8">
          ...
          <p className="text-muted-foreground">
            This is a fully functional timeline component with drag-and-drop scheduling. Try dragging slots between
            different rows and watch for conflict validation.
          </p>
              ...
              {dummyRows.map(row => (
                ...
                >
                  {(slot: TimelineSlotData) => (
                    <TimelineSlot
                      slot={slot}
                      className={cn("gap-0 flex flex-col items-start justify-center px-2 bg-background dark:bg-muted")}
                    >
